...
exports.doRegistration = function (req, conn, cb) {
    ...
    var sql_usr = "insert into bmtc.bmtc_user_details (first_name, last_name, user_gender, dob, user_address, user_avatar ) values ('" + fname + "', '" + lname + "', '" + gender + "', '" + dob + "', '" + address + "','"+avatar+"')";
